...
```
cd existing_repo
git remote add origin https://gitlab.com/mladenqdev/yt-trackback.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mladenqdev/yt-trackback/-/settings/integrations)
